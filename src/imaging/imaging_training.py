...
from src.imaging.imaging_datamodule import LitImageDataModule
...
def imaging_training(
    ...
    datamodule.train_dataset.transform = model.preprocess
    datamodule.val_dataset.transform = model.preprocess
    ...
    print(f"-----------------------------Starting training imaging_training at time {time_string}-----------------------------")
